...
#two Hahs syntax the => and the :   => says "this state" is equal to all this information and then the : has the specific information. 
...
STATE_DATA = {  "Alabama" => {population_density: 94.65, population: 4822023, region: 5, regional_spread: 3},
    ...
    "Arizona" => {state: "Arizona", population_density: 57.05, population: 6553255, region: 8, regional_spread: 8},
